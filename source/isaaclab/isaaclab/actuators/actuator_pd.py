...
class DelayedImplicitActuator(ImplicitActuator):
    ...
    def set_max_delay(self, max_delay):
        ...
        self.positions_delay_buffer = DelayBuffer(max_delay, self._num_envs, device=self._device)
        self.velocities_delay_buffer = DelayBuffer(max_delay, self._num_envs, device=self._device)
        self.efforts_delay_buffer = DelayBuffer(max_delay, self._num_envs, device=self._device)
